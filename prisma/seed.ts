...
async function main() {
    ...
    const blogArticles = [
        { title: "Server Launch Announcement", slug: "server-launch", excerpt: "We are excited to announce the official launch!", coverImage: "/background1.jpg", content: "We are thrilled to announce that our server is now officially live!\n\n**What to expect:**\n- Survival mode with custom features\n- Active staff team\n- Regular events and updates\n\nJoin us today!", status: "PUBLISHED" as const, publishedAt: new Date(), categoryId: newsCategory.id },
