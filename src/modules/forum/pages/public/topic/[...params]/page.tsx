                    ...
                    <>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex items-center gap-3 text-sm text-gray-500">
                                ...
                                <button
                                    onClick={toggleLike}
                                    className={`flex items-center gap-1 px-2 py-0.5 rounded transition-colors ${liked ? "bg-blue-100 text-blue-600" : "hover:bg-gray-100"}`}
                                >
                        ...
                        <Card className="mb-4 border-l-4 border-l-blue-500">
                            <CardContent className="p-5">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        <p className="font-medium text-gray-900">{topic.author.username}</p>
                                        <p className="text-xs text-gray-500">{formatRelativeTime(new Date(topic.createdAt))}</p>
                                    </div>
                                </div>
                        ...
                        {topic.posts.length > 0 && (
                            <div className="space-y-3 mb-6">
                                <h3 className="text-sm font-medium text-gray-500">{topic.posts.length} replies</h3>
            ...
            <CardContent className="p-5">
                <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500">{formatRelativeTime(new Date(post.createdAt))}</p>
                    </div>
                </div>
                <div className="text-gray-700 text-sm whitespace-pre-wrap mb-3">{post.content}</div>
                <button
                    onClick={togglePostLike}
                    className={`flex items-center gap-1 text-xs px-2 py-1 rounded transition-colors ${postLiked ? "bg-blue-100 text-blue-600" : "text-gray-400 hover:bg-gray-100 hover:text-gray-600"}`}
                >
