    ...
    return (
        <>
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">{total} topics total</p>
            </div>
                                        ...
                                        <tr key={topic.id} className="hover:bg-muted/50">
                                            <td className="py-3 px-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {topic.isLocked && <Lock className="w-3 h-3 text-gray-400 flex-shrink-0" />}
                                                    <div>
                                            ...
                                            <td className="py-3 px-4">
                                                <div className="flex gap-1">
                                                    {topic.isPinned && <span className="text-xs bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded">Pinned</span>}
                                                    {topic.isLocked && <span className="text-xs bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded">Locked</span>}
                                                </div>
                                            </td>
