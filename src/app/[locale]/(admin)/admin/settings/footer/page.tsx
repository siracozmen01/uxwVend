    ...
    return (
        <SettingsForm
            ...
            fields={[
                ...
                { key: "footer_quick_links", label: "Quick Links (JSON)", type: "textarea", placeholder: '[{"label":"Link 1","href":"/page1"},{"label":"Link 2","href":"/page2"}]', description: "JSON array of {label, href} objects" },
